...
#import "CMMyYHCell.h"
@interface CMMiaoSecuritiesView ()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic,strong)UITableView *myTableView;
@property(nonatomic,strong)NSMutableArray *dataArry;
@property(nonatomic,strong)CMRecordBgView *rbgView;
@end

@implementation CMMiaoSecuritiesView
...
-(instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        self.myTableView.mj_footer=[MJRefreshBackNormalFooter footerWithRefreshingBlock:^{
            ...
            [self requestDataWithType:@"1" WithPage:pag];
        }];
...
-(void)LoadData{
    ...
    [self requestDataWithType:@"1" WithPage:@"1"];
}
