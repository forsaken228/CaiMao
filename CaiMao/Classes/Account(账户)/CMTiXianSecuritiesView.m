...
#import "CMMyYHCell.h"
@interface CMTiXianSecuritiesView ()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic,strong)UITableView *myTableView;
@property(nonatomic,strong)NSMutableArray *dataArry;
@property(nonatomic,strong)CMRecordBgView *rbgView;
@end
@implementation CMTiXianSecuritiesView
...
-(instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        self.myTableView.mj_footer=[MJRefreshBackNormalFooter footerWithRefreshingBlock:^{
            ...
            [self requestDataWithType:@"2" WithPage:pag];
        }];
...
-(void)LoadData{
    ...
    [self requestDataWithType:@"2" WithPage:@"1"];
}
